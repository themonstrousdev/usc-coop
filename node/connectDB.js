      ...
      if(err) {
        ...
        if(res.length == 0) {
          ...
          query = `CREATE DATABASE ${mydb}; 
                  ...
                  CREATE TABLE announcements(id INT AUTO_INCREMENT PRIMARY KEY NOT NULL, title VARCHAR(30) NOT NULL, img VARCHAR(255) DEFAULT "images/logo/usc-logo.png", author INT NOT NULL, date_created DATETIME, tags JSON, content LONGTEXT NOT NULL, FOREIGN KEY (author) REFERENCES accounts(id));
